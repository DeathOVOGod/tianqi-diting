...
- Notebooks with no clear narrative flow
- CSS/styling scattered without reason
...
- When context is missing, flag the risk rather than assuming failure
- For iterative reviews, focus on the delta
...
- For unfamiliar frameworks, note the concern and defer to team conventions
